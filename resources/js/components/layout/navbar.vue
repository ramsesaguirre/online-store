<template>
    <div class="header">
        <div class="container">
            ...
            <div class="logo rubberBand animated">
                <h1 ><a href="#"><b>T<br>H<br>E</b>Big Store<span>The Best Supermarket</span></a></h1>
            </div>
            <div class="head-t">
                <ul class="card">
                    <li>
                        <router-link :to="{ name: 'login' }"><i class="fa fa-user" aria-hidden="true"></i>Login</router-link>
                    </li>
                    <li>
                        <router-link :to="{ name: 'register' }"><i class="fa fa-arrow-right" aria-hidden="true"></i>Register</router-link>
                    </li>
                    <li>
                        <router-link :to="{ name: 'shipping' }"><i class="fa fa-ship" aria-hidden="true"></i>Shipping</router-link>
                    </li>
                </ul>	
            </div>
            <div class="header-ri">
            ...
            <div class="nav-top">
                ...
                <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                    <ul class="nav navbar-nav ">
                        <li class="active"><router-link :to="{ name: 'home' }" class="hyper"><span>Home</span></router-link></li>	
                            ...
                            <ul class="dropdown-menu multi">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 w3l">
                                        <a href="kitchen.html"><img src="assets/images/me.png" class="img-responsive" alt=""></a>
                                    </div>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu multi multi1">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 w3l">
                                        <a href="care.html"><img src="assets/images/me1.png" class="img-responsive" alt=""></a>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>	
                            </ul>
                        ...
                        <li>
                            <router-link :to="{ name: 'contact' }" class="hyper"><span>Contact Us</span></router-link>
                        </li>
                    </ul>
                </div>
                </nav>
